...
public class KurAverage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kur_average);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Notes deleted!", Snackbar.LENGTH_LONG)
                                        ...
                                        btn_Calculate.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                if(n3>60){
                                                    if (ortalama2>=60)
                                                    {
                                                        Toast.makeText(getApplicationContext(),"Tebrikler. Hazırlık Sınıfını başarıyla geçtin.",Toast.LENGTH_LONG).show();
                                                    }else{
                                                        if(n4<=160)
                                                        {
                                                            Toast.makeText(getApplicationContext(),"Haziran FLAT sınavına girebilirsin",Toast.LENGTH_LONG).show();
